    ...
    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input
                ...
                class="file:rounded-lg file:border-none file:bg-blue-600 file:text-white file:px-4 file:py-2 file:cursor-pointer text-gray-400"
            />
        </div>
        ...
        <div class="mt-6 space-y-4">
            ...
            class={`mt-2 w-full rounded-lg border-2 border-dashed ${
                isDragging ? 'border-blue-500 bg-gray-800' : 'border-gray-700 bg-gray-900'
        ...
        >
            <p class="text-sm">
                ...
                {:else}
                    Drag & drop files here or <span class="text-blue-400 underline">browse files</span>
                {/if}
